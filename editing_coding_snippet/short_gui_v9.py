...
class OptimizedVideoProcessor:
    ...
    def get_animation_tag(self, animation_type, start, end):
        ...
        if animation_type == "Fade In/Out":
            fade_in = int(duration * 1000 * 0.2)  # 20% of duration
...
""")
            ...
            logging.info(f"✅ Generated enhanced ASS subtitles with {mode_text}{border_text}{animation_text}")
        except Exception as e:
            ...
            try:
                ...
                if words:
                    try:
                        ...
                        animation_text = f" with {subtitle_settings['animation_type']} animation" if subtitle_settings['enable_animation'] else ""
                        logging.info(f"📝 Adding {mode_text} enhanced subtitles{border_text}{animation_text}...", extra={'is_status': True})
